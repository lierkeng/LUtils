...
public class UtilsArray {
    ...
    public static <V> V getLast(V[] sourceArray, V value, V defaultValue, boolean isCircle) {
        ...
        for (int i = 0; i < sourceArray.length; i++) {
            if (UtilsObject.isEquals(value, sourceArray[i])) {
                currentPosition = i;
                break;
            }
        }
    ...
    /**
     * see (Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link (Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link (Object[], Object, Object, boolean)} Object is Long
     */
    public static long getLast(long[] sourceArray, long value, long defaultValue, boolean isCircle) {
        ...
        Long[] array = UtilsObject.transformLongArray(sourceArray);
    ...
    /**
     * @see {@link (Object[], Object, Object, boolean)} Object is Integer
     */
    public static int getLast(int[] sourceArray, int value, int defaultValue, boolean isCircle) {
        ...
        Integer[] array = UtilsObject.transformIntArray(sourceArray);
        return getLast(array, value, defaultValue, isCircle);
