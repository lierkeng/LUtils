...
public class UtilsList {
    ...
    public static <V> boolean isEquals(ArrayList<V> actual, ArrayList<V> expected) {
        ...
        for (int i = 0; i < actual.size(); i++) {
            if (!UtilsObject.isEquals(actual.get(i), expected.get(i))) {
                return false;
            }
        }
        return true;
    ...
    /**
     * @see {@link UtilsArray#getLast(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getLast(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V) UtilsArray.getLast(sourceList.toArray(), value, true);
    }

    /**
     * @see {@link UtilsArray#getNext(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getNext(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V) UtilsArray.getNext(sourceList.toArray(), value, true);
    }
